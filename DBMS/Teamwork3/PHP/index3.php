		...
		<div class="banner">
			<article id="intro">
				...
				<hr><form method="post" action="index3.php">
					<h3>O_ID:</h3><textarea name="Sql"></textarea></br>
				...
				-->
				<?php include 'oderhistory_user.php';?>
				
			</article>
			
			<article id="new">
				<h2 class="major">Add</h2>					
				<form method="post" action="odd_add.php">
					<h3>O_ID:<input type="text" name="oid"><br/>
					<h3>M_ID:<input type="text" name="mid"><br/>
					<h3>M_Count:<input type="text" name="mcn"><br/>
					<h3>M_Amount:<input type="text" name="man"><br/>
					<h3>Date:<input type="text" name="odt"><br/>
			...
			<article id="del">
				<h2 class="major">Delete</h2>
					<form method="post" action="odd_del.php">
					<h3>O_ID:<input type="text" name="oid"><br/>
			...
			<article id="mod">
				...
				<form method="post" action="odd_mod.php">
					<h3>欲修改清單號碼:<input type="text" name="oid"><br/>
					<h3>M_ID:<input type="text" name="mid"><br/>
					<h3>M_Count:<input type="text" name="mcn"><br/>
					<h3>M_Amount:<input type="text" name="man"><br/>
					<h3>Date:<input type="text" name="odt"><br/>
