		...
		<div class="banner">
			<article id="intro">
				...
				<hr><form method="post" action="index2.php">
					<h3>B_ID:</h3><textarea name="Sql"></textarea></br>
			...
			<article id="new">
				...
				<form method="post" action="boo_add.php">
					<h3>B_ID:<input type="text" name="bid"><br/>
					<h3>B_name:<input type="text" name="bna"><br/>
					<h3>P_ID:<input type="text" name="pid"><br/>
					<h3>Price<input type="text" name="bpr"><br/>
					<h3>ISBN:<input type="text" name="bISBN"><br/>
					<h3>Author:<input type="text" name="bar"><br/>
			...
			<article id="del">
				<h2 class="major">Delete</h2>
					<form method="post" action="boo_del.php">
					<h3>B_ID:<input type="text" name="bid"><br/>
			...
			<article id="mod">
				...
				<form method="post" action="boo_mod.php">
					<h3>B_ID:<input type="text" name="bid"><br/>
					<h3>B_name:<input type="text" name="bna"><br/>
					<h3>P_ID:<input type="text" name="pid"><br/>
					<h3>Price<input type="text" name="bpr"><br/>
