...
if (isset($_POST['button'])){
	switch($_POST['button']){
			case '查詢':	
				...
				if ( mysqli_errno1($link) != 0 ) {
					echo "錯誤代碼: ".mysqli_errno1($link)."<br/>";
					...
					if (mysqli_num_rows($result)<=0){
						...
						echo "<form method='post'>
							...
							<tr><td>電話號碼:</td><td><input type='text' name='homework'></br></td></tr>
							<tr><td>地址:</td><td><input type='text' name='project'></br></td></tr>
							</table>
